<?php
    ...
    $username = "root";
    $pass = "foobar";  
        $con = mysqli_connect ($host , $username , "", 'travel') or die("unable to connect to host");  
   
	date_default_timezone_set("Asia/Kolkata");
    if(isset($_POST['id'])){
        $id = $_POST['id'];
		$new_date = $_POST['new_date'];
        $result = mysqli_query($con,"select * from pass where id = '$id'");
		$row = mysqli_fetch_array($result);
		
		mysqli_query($con,"UPDATE pass SET date = '$new_date' WHERE id = '$id'");
          ...
          <div class="col-50">
            ...
            <div class="icon-container">
			  ...
			  <div>Rs. 
				<?php
					$dest = $row['dest'];
					$price = mysqli_fetch_assoc(mysqli_query($con,"select price from destination where name = '$dest'"))['price'];
					$amt = $price * $nod;
					echo $amt;
				?>
			  </div>
        ...
        <div class="row">
          <div class="col-lg-4">
            <div class="mb-5">
              ...
              <p>Provides a pass for their travel from Konkan Gyanpeeth College of Engineering, Karjat to multiple destinations around.</p>
            </div>
